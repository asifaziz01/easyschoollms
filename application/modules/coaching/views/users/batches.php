			...
			<li class="list-group-item d-flex flex-sm-row flex-column">
				<div class="flex-grow-1 my-auto">
					...
					<p class="text-muted mb-0">
						...
						<?php endif; ?>
						<a href="<?php echo site_url ('coaching/users/batch_users/'.$coaching_id.'/'.$row['batch_id']); ?>" class="text-muted"><?php echo $num; ?> Users</a>

					</p>
				</div>
				<div class="flex-shrink-1 px-sm-3 my-auto">					
					<div class="btn-group">
						<a href="<?php echo site_url('coaching/users/create_batch/'.$coaching_id.'/'.$row["batch_id"]); ?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i><span class="d-none d-lg-inline ml-2"></span></a>	
						<a href="javascript:void(0);" onclick="show_confirm ('Are you sure delete this batch?', '<?php echo site_url('coaching/user_actions/delete_batch/'.$coaching_id.'/'.$row["batch_id"]); ?>')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i><span class="d-none d-lg-inline ml-2"></span></a>
