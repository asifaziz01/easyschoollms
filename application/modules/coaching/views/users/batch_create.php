			...
			<?php echo form_open("coaching/user_actions/create_batch/".$coaching_id."/".$batch_id, array('class'=>'form-horizontal batch-border ', 'id'=>'validate-1' )); ?>
				<div class="card-body">
					...
					<div class="form-group row">
					  <div class="col-md-12">
						<?php echo form_label('Class Name<span class="required">*</span>', '', array('class'=>'control-label')); ?>
							<?php echo form_input ( array('name'=>'batch_name', 'class'=>'form-control required', 'value'=>set_value('batch_name', $batch['batch_name']), 'autofocus'=>true) );?> 
					  </div>
					</div>	
