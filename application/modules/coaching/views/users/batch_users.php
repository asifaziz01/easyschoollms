<div class="row" >
	<div class="col-md-12">
		<ul class="nav nav-tabs" id="users" role="tablist">
		  <li class="nav-item">
			<a class="nav-link <?php if ($add_users == 0) echo 'active'; ?>" href="<?php echo site_url ('coaching/users/batch_users/'.$coaching_id.'/'.$batch_id )?>" >Students In Class <span class="badge badge-primary"><?php echo $num_users_in; ?></span></a>
		  </li>
		  <li class="nav-item">
			<a class="nav-link <?php if ($add_users == TRUE) echo 'active'; ?>" href="<?php echo site_url ('coaching/users/batch_users/'.$coaching_id.'/'.$batch_id.'/1' )?>" >Add More Students <span class="badge badge-primary"><?php echo $num_users_notin; ?></span></a>
		  </li>
		</ul>
	</div>
</div>
		...
		<div class="card">
			...
			?>				
				...
				<div class="card-footer">
					...
					<?php } ?>
					<?php echo anchor ('coaching/users/import/'.$coaching_id.'/'.USER_ROLE_STUDENT.'/'.$batch_id, 'Import Users', ['class'=>'btn btn-outline-primary']); ?>
				</div>
