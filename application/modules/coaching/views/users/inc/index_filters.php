<div class="mb-2">
    ...
    <div class="collapse d-md-block" id="displayOptions">
      ...
      <div class="d-sm-flex align-items-end">
        ...
        <div class="d-inline-block">
            <small class="d-block text-center">Classes</small>
            <div class="btn-group float-md-left mr-1 mb-1">
                <button class="btn btn-outline-dark btn-xs dropdown-toggle" type="button"
                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <?php echo $batch_label; ?>
                </button>
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="role dropdown-item<?php if ($batch_id == 0) echo ' active'; ?>" href="<?php echo site_url ('coaching/users/index/'.$coaching_id.'/'.$role_id.'/'.$status.'/0'); ?>">All Classes</a>
                    <?php foreach ($batches as $batch) { ?>
                    <a class="role dropdown-item<?php if ($batch_id == $batch['batch_id']) echo ' active'; ?>" href="<?php echo site_url ('coaching/users/index/'.$coaching_id.'/'.$role_id.'/'.$status.'/'.$batch['batch_id']); ?>"><?php echo $batch['batch_name']; ?></a>
                    <?php } ?>
                </div>
            </div>
        </div>
