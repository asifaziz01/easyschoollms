...
class Announcements_model extends CI_Model {
	...
	public function get_announcement ($coaching_id=0, $course_id=0, $announcement_id=0) {
	...
	public function get_announcements ($coaching_id=0, $course_id=0) {
		$this->db->where ('coaching_id', $coaching_id);
		$this->db->where ('course_id', $course_id);
	...
	public function delete_announcement ($coaching_id=0, $course_id=0, $announcement_id=0) {
		$this->db->where ('announcement_id', $announcement_id);
		$this->db->delete ('coaching_announcements');
		redirect ('coaching/announcements/index/'.$coaching_id.'/'.$course_id);
	}	
}