            ...
            <div class="form-side">
                ...
                <?php echo form_open ('login/login_actions/register', array('id'=>'validate-1')); ?>
                    ...
                    <div class="form-group mb-4">
                        <label class="">
                            <span>Enrolment No</span><span class="text-danger">*</span>
                        </label>
                    	<input type="text" name="login" class="form-control required"  value="<?php echo set_value ('login'); ?>" placeholder="Enter Enrolment No" />
                    </div>

                    <div class="form-group mb-4">
                        <label class="">
                            <span>Student Name</span><span class="text-danger">*</span>
                        </label>
                    ...
                    <div class="form-group mb-4">
                        <label class="">
                            <span>Parent/Guardian Mobile</span><span class="text-danger">*</span>
                        </label>
