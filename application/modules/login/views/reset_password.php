            ...
            <div class="form-side">
                ...
                <?php echo form_open ('login/login_actions/reset_password', array('id'=>'validate-1')); ?>
                    ...
                    <div class="form-group mb-4">
                        <label class="">
                            <span>Enrolment No<span class="text-danger">*</span></span>
                        </label>
                        <input name="login" class="form-control required" placeholder="Enter Your Enrolment No" autofocus="autofocus" id="mobile" />
                    </div>
                    <div class="form-group mb-4">
