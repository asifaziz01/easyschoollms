...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(THEME_PATH . 'assets/css/custom.css'); ?>" />
    <?php
    if (isset ($style)) {
        echo $style;   
    }
...
<body id="app-container" class="menu-sub-hidden show-spinner <?php if (isset ($right_sidebar)) { echo 'right-menu'; } else { echo 'vertical boxed'; } ?> ">
    ...
    <nav class="navbar fixed-top">
        ...
        <div class="d-flex align-items-center navbar-left">
            ...
            <a class="btn btn-xs btn-outline-dark ml-3 " href="<?php echo site_url ('coaching/subscription/index/'.$coaching_id); ?>"><i class="iconsminds-box-close"></i> <span class="d-none d-md-inline-block">Subscription</span></a>
        </div>
